...
begin
   ...
   DbGridIncomingFile.Columns[0].Title.Caption := 'Имя файла';
end;
...
begin
   ...
   DbGridIncoming.Columns[1].Title.Caption := 'Номер письма';
   DbGridIncoming.Columns[2].Width := 300;
   DbGridIncoming.Columns[2].Title.Caption := 'Краткая суть письма';
   DbGridIncoming.Columns[3].Width := 100;
   DbGridIncoming.Columns[3].Title.Caption := 'Дата';
   DbGridIncoming.Columns[4].Width := 70;
   DbGridIncoming.Columns[4].Title.Caption := 'Время';
   DbGridIncoming.Columns[5].Width := 220;
   DbGridIncoming.Columns[5].Title.Caption := 'Статус';
end;
